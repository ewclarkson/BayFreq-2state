...
freqEstNo = cell(1,numExp);
freqEstFP = cell(1,numExp);
freqEstFN = cell(1,numExp);
...
for idx = 1:numExp
    ...
    % ----------- do analysis without corrections ---------------
...
% legend({'Ground truth','FP and FN', 'No correction', 'FP only', 'FN only'}, 'Location', 'Northwest')
